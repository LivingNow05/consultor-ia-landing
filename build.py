        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="bg-[#FDFBF7] dark:bg-zinc-900/50 border border-gray-border dark:border-zinc-800 rounded-3xl p-8 shadow-2xl flex flex-col md:flex-row gap-12 backdrop-blur-sm">
                ...
                <div class="w-full md:w-1/2 flex flex-col justify-center space-y-10">
                    <div>
                        <div class="flex justify-between mb-4">
                            ...
                            <span id="calc-chats-val" class="text-[#28D366] font-bold text-2xl">50</span>
                        </div>
                        <input type="range" id="calc-chats" min="10" max="500" value="50" class="w-full h-2 bg-zinc-200 dark:bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-[#28D366]">
                    ...
                    <div>
                        <div class="flex justify-between mb-4">
                            ...
                            <span id="calc-ticket-val" class="text-[#28D366] font-bold text-2xl">{moneda} 100</span>
                        </div>
                        <input type="range" id="calc-ticket" min="10" max="1000" step="10" value="100" class="w-full h-2 bg-zinc-200 dark:bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-[#28D366]">
                ...
                <div class="w-full md:w-1/2 bg-white dark:bg-zinc-950/80 border border-gray-100 dark:border-zinc-800 rounded-2xl p-8 flex flex-col justify-center space-y-8 shadow-inner">
                    ...
                    <div class="text-center bg-[#28D366]/5 dark:bg-[#28D366]/10 rounded-2xl p-6 border border-[#28D366]/20">
                        <p class="text-xs text-[#28D366] dark:text-[#28D366] font-bold mb-2 uppercase tracking-tighter">Ingresos Extra Estimados (Mes)</p>
                        <div class="text-4xl font-header font-extrabold text-[#28D366]" id="res-revenue">{moneda} 4,500</div>
...
def build_pillar_content(row):
    ...
    PILLAR_DATA = {
        'ia-para-negocios': {
            ...
            'stats': [('73%', 'de PYMES LATAM pierde clientes por respuesta tardía'), ('3 seg', 'tiempo de respuesta promedio del agente IA'), ('40%', 'más conversiones vs. atención manual'), ('USD 79', 'costo mensual desde')],
        ...
        'consultor-inteligencia-artificial': {
            ...
            'stats': [('10+', 'industrias atendidas en LATAM'), ('5 días', 'tiempo promedio de implementación'), ('60-90', 'días para recuperar la inversión'), ('9 países', 'presencia en LATAM')],
        ...
        'ia-para-empresas': {
            ...
            'stats': [('80%', 'de consultas repetitivas automatizadas'), ('10 días', 'de piloto hasta tener datos reales'), ('60-90', 'días para recuperar inversión'), ('24/7', 'operación sin descanso')],
        ...
        'ia-para-industria': {
            ...
            'stats': [('98%', 'tasa de apertura en WhatsApp vs 22% del email'), ('60%', 'reducción de llamadas en manufactura'), ('10+', 'industrias con casos documentados'), ('48h', 'tiempo de respuesta reducido a segundos')],
        ...
        'automatizacion-con-ia': {
            ...
            'stats': [('73%', 'de PYMES pierde clientes por respuesta tardía'), ('72h', 'para tener automatización activa'), ('80%', 'de tareas repetitivas eliminadas'), ('40%', 'reducción de ausentismo con recordatorios')],
        ...
        'transformacion-digital-con-ia': {
            ...
            'stats': [('5 días', 'para tener el agente operando'), ('4 semanas', 'para ver ROI visible'), ('12-24 meses', 'transformación profunda completa'), ('0', 'sistemas existentes tocados en fase 1')],
        ...
        'ia-para-pymes': {
            ...
            'stats': [('USD 79', 'costo mensual desde'), ('20%', 'del salario de un asesor de atención'), ('∞', 'conversaciones simultáneas sin costo extra'), ('48h', 'onboarding express')],
        ...
        'ia-para-retail': {
            ...
            'stats': [('3 seg', 'tiempo de respuesta a consultas de stock'), ('+28%', 'recuperación de carritos abandonados'), ('85%', 'consultas resueltas sin intervención humana'), ('24/7', 'atención en WhatsApp')],
        ...
        'ia-para-salud': {
            ...
            'stats': [('80%', 'de gestión administrativa automatizada'), ('30-45%', 'reducción de ausentismo en citas'), ('40h', 'mensuales ahorradas por recepcionista'), ('5-10 días', 'de implementación')],
        ...
        'ia-para-restaurantes': {
            ...
            'stats': [('3 seg', 'tiempo de respuesta por WhatsApp'), ('+34%', 'más reservas confirmadas en 60 días'), ('85%', 'conversaciones sin intervención humana'), ('25%', 'de reservas recuperadas que se perderían')],
        ...
        'ia-para-hoteles': {
            ...
            'stats': [('68%', 'de viajeros consulta por WhatsApp antes de reservar'), ('10 min', 'margen para responder antes de perder la reserva'), ('3 idiomas', 'español, inglés y portugués sin configuración extra'), ('15-25%', 'ahorro en comisiones de OTAs')],
        ...
        'ia-para-salones-de-belleza': {
            ...
            'stats': [('35%', 'reducción de ausencias con recordatorios automáticos'), ('11pm', 'el agente responde cuando tú duermes'), ('+20%', 'aumento en ticket promedio con fidelización'), ('48h', 'para tener la agenda digital activa')],
        ...
        'ia-para-inmobiliarias': {
            ...
            'stats': [('3-5%', 'tasa de cierre sin IA'), ('8%+', 'tasa de cierre con agente IA'), ('5x', 'más leads calificados por semana'), ('1 min', 'margen antes de que el lead se enfríe')],
        ...
        'precios-agente-ia-latam': {
            ...
            'stats': [('USD 79', 'plan básico desde'), ('USD 400-800', 'costo mensual de un asesor humano'), ('5x', 'ahorro promedio vs. atención manual'), ('0', 'penalidad por cancelación')],
    ...
    <section class="py-16">
        ...
        'como-implementar-agente-ia': {
            ...
            'stats': [('5-10', 'días hábiles hasta el lanzamiento'), ('3-4h', 'tu tiempo total invertido en el proceso'), ('14 días', 'garantía de devolución si no funciona'), ('30 días', 'de monitoreo post-lanzamiento incluido')],
        ...
        'agente-ia-vs-chatbot': {
            ...
            'stats': [('3-4x', 'mayor tasa de resolución con agente IA vs chatbot'), ('98%', 'satisfacción con conversación natural'), ('+30%', 'más caro el agente IA, pero con ROI 3x mayor'), ('0', 'clientes frustrados por menús de opciones')],
    ...
    <section class="py-16 bg-zinc-50 dark:bg-zinc-900/30">
        ...
        'casos-exito-ia-pymes': {
            ...
            'stats': [('28%→11%', 'ausentismo en clínica dental Bogotá'), ('+34%', 'reservas en restaurante CDMX a 60 días'), ('3%→8%', 'tasa de cierre en inmobiliaria Buenos Aires'), ('40h', 'mensuales recuperadas por recepcionista')],
