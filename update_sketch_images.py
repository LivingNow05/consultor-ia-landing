...
# Find all new sketch PNGs
sketches = glob.glob("/Users/anthony/.gemini/antigravity/brain/55acae4e-3da3-4c80-aa4d-5b5e559ab950/*_sketch_*.png")
    ...
    for key, val in name_mapping.items():
        if filename.startswith(key):
            try:
                ...
                print(f"Updated {val} with new sketch style.")
